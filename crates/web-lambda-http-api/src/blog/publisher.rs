...
///
/// ```text
/// api/v2/blog/list/{en|ja}.json
/// api/v2/blog/contents/{slug}/{en|ja}.json
/// api/v2/blog/tags.json
/// api/v2/blog/{slug}/og-image/{en|ja}
/// api/v2/blog/block-image/{block_id}/{default|small|medium|large}
/// api/v2/blog/feed/{rss|atom|json-feed}/{en|ja}.{xml|json}
/// api/v2/blog/sitemap.xml
/// ```
...
pub async fn rebuild_cache() -> Result<RebuildSummary, PublisherError> {
    ...
    for language in [BlogLanguageEntity::En, BlogLanguageEntity::Ja] {
        ...
        storage
            .put_json(&format!("api/v2/blog/list/{lang}.json"), &list)
            .await?;
        ...
        for blog in &blogs {
            ...
            storage
                .put_json(
                    &format!("api/v2/blog/contents/{}/{lang}.json", blog.slug),
                    &response,
                )
                .await?;
            summary.objects_written += 1;
        ...
        storage
            .put_text(
                &format!("api/v2/blog/feed/rss/{lang}.xml"),
        ...
        storage
            .put_text(
                &format!("api/v2/blog/feed/atom/{lang}.xml"),
        ...
        storage
            .put_text(
                &format!("api/v2/blog/feed/json-feed/{lang}.json"),
    ...
    let tags: Vec<BlogTagResponse> = use_case
        ...
        .collect();
    storage.put_json("api/v2/blog/tags.json", &tags).await?;
...
/// Issues a targeted CloudFront invalidation (`/api/v2/blog/*`) so a freshly
...
async fn invalidate_cdn() -> Result<String, PublisherError> {
    ...
    tracing::info!(invalidation_id, "created CloudFront invalidation for /api/v2/blog/*");
    Ok(invalidation_id)
}
