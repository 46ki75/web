...
pub async fn list_blogs(
    ...
    serve_cached(
        &state,
        &format!("api/v2/blog/list/{lang}.json"),
        "application/json",
        true,
    )
    .await
...
pub async fn get_blog_contents(
    ...
    serve_cached(
        &state,
        &format!("api/v2/blog/contents/{slug}/{lang}.json"),
        "application/json",
        true,
    )
    .await
...
pub async fn list_tags(
    ...
    serve_cached(&state, "api/v2/blog/tags.json", "application/json", false).await
}
...
pub async fn get_blog_og_image(
    ...
    serve_cached_image(
        &state,
        &format!("api/v2/blog/{slug}/og-image/{lang}"),
        CACHE_VALUE,
    )
    .await
}
...
pub async fn get_blog_block_image(
    ...
    serve_cached_image(
        &state,
        &format!("api/v2/blog/block-image/{block_id}/{variant}"),
...
pub async fn get_blog_sitemap(
    ...
    serve_cached(&state, "api/v2/blog/sitemap.xml", "application/xml", false).await
}
