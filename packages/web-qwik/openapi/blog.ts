...
export const getBlogList = (language: BlogLanguage, signal?: AbortSignal) =>
  getJson<BlogResponse[]>(`/api/v2/blog/list/${language}.json`, signal);
